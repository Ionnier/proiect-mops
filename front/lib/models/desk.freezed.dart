...
class _$DeskImpl implements _Desk {
  const _$DeskImpl({required this.id, required this.location});
  ...
  @override
  String toString() {
    return 'Desk(id: $id, location: $location)';
  }
...
abstract class _Desk implements Desk {
  const factory _Desk({required final int id, required final String location}) =
      _$DeskImpl;
