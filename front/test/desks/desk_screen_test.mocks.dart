...
// in front/test/desks/desk_screen_test.dart.
...
class _FakeFileInfo_2 extends _i1.SmartFake implements _i4.FileInfo {
  _FakeFileInfo_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBaseCacheManager extends _i1.Mock implements _i7.BaseCacheManager {
  ...
  @override
  _i6.Stream<_i8.FileResponse> getFileStream(
    String? url, {
    String? key,
    Map<String, String>? headers,
    bool? withProgress,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i6.Stream<_i8.FileResponse>.empty(),
      ) as _i6.Stream<_i8.FileResponse>);
  ...
  _i6.Future<_i4.FileInfo> downloadFile(
    ...
    bool? force = false,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i6.Future<_i4.FileInfo>.value(_FakeFileInfo_2(
          this,
          Invocation.method(
            #downloadFile,
            [url],
